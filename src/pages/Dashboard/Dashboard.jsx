...
function Dashboard() {
    ...
    const renderLineChart = () => {
        const chart = document.querySelector('#chartline');
        const options = {
            series: [
                {
                    name: 'TEAM A',
        ...
        const lineChart = new ApexCharts(chart, options);
        lineChart.render();
    };

    const renderPieChart = () => {
        const chart = document.querySelector('#chartpie');
        const options = {
            series: [44, 55, 67, 83],
            chart: {
                height: 350,
        ...
        const pieChart = new ApexCharts(chart, options);
        pieChart.render();
    };
    ...
    return (
        <div className="flex h-screen bg-gray-800">
            {/* Desktop sidebar */}
            <aside
                className={`z-20 flex-shrink-0 hidden w-60 pl-2 overflow-y-auto bg-gray-800 md:block ${isSideMenuOpen ? 'block' : 'hidden'
                    }`}
            >
                <div>
                            ...
                            <ul className="mt-6 leading-10">
                                ...
                                <li className="relative px-2 py-1">
                                    ...
                                    {isNotificationsMenuOpen && (
                                        <div className="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium rounded-md shadow-inner bg-green-400">
                                            <ul>
            ...
            <aside
                className={`fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-gray-900 dark:bg-gray-800 md:hidden ${isSideMenuOpen ? 'block' : 'hidden'
                    }`}
            >
                <div>
                    <div className="text-white">
                                        ...
                                        <span className="inline-flex items-center text-sm font-semibold text-white hover:text-green-400">
                                            ...
                                            >
                                                <path
                                                    ...
                                                    strokeLinejoin="round"
                                                    strokeWidth="2"
                                                    d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a 1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20"
                                                />
                                            </svg>
                                            <span className="ml-4">ITEM</span>
                                        </span>
